...
#
max_threads_count = ENV.fetch("RAILS_MAX_THREADS") { Rails.env.production? ? 16 : 5 }
min_threads_count = ENV.fetch("RAILS_MIN_THREADS") { Rails.env.production? ? 4 : max_threads_count }
